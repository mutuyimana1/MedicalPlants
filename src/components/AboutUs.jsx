...
const AboutUs = () => {
  ...
  return (
    ...
    <div className="bg-white block md:flex justify-between px-10 pt-10">
      ...
      <div className="w-full md:w-2/3 pts-80 mds:pt-10 relative -top-20">
        <h1 className="text-4xl font-medium leading-[4rem] text-[#363636] w-full  ">Make Your Skin Shine & Be Good to your Skin.</h1>
    ...
    <h1 className="text-center font-medium  text-2xl ">Get More Information about Side Effects of using medicinal Plants</h1>
      ...
      <ProductCard  img1={aboutImage1} img2={aboutImage2} name={"Urtica massaica"} btnName={"ReadMore"} description={"Fresh roots are crushed, boiled and strained, and the liquid is used to treatgonorrhoea and syphilis"} onClick={()=>navigate("/product/info")}/>
      <ProductCard  img1={aboutImage1} img2={aboutImage2} name={"Urtica massaica"} btnName={"ReadMore"} description={"Fresh roots are crushed, boiled and strained, and the liquid is used to treatgonorrhoea and syphilis"} onClick={()=>navigate("/product/info")}/>
      <ProductCard  img1={aboutImage1} img2={aboutImage2} name={"Urtica massaica"} btnName={"ReadMore"} description={"Fresh roots are crushed, boiled and strained, and the liquid is used to treatgonorrhoea and syphilis"} onClick={()=>navigate("/product/info")}/>
      <ProductCard  img1={aboutImage1} img2={aboutImage2} name={"Urtica massaica"} btnName={"ReadMore"} description={"Fresh roots are crushed, boiled and strained, and the liquid is used to treatgonorrhoea and syphilis"} onClick={()=>navigate("/product/info")}/>
      <ProductCard  img1={aboutImage1} img2={aboutImage2} name={"Urtica massaica"} btnName={"ReadMore"} description={"Fresh roots are crushed, boiled and strained, and the liquid is used to treatgonorrhoea and syphilis"} onClick={()=>navigate("/product/info")}/>
      ...
      <div className="p-10 px-20 grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 2xl:grid-cols-5 gap-5 w-full m-auto">
        <ProductCard  img1={aboutImage1} img2={aboutImage2} name={"Urtica massaica"}amount={40000} btnName={"ReadMore"}  description={"Fresh roots are crushed, boiled and strained, and the liquid is used to treatgonorrhoea and syphilis"} onClick={()=>navigate("/product/info")}/>
        <ProductCard  img1={aboutImage1} img2={aboutImage} name={"Rubia cordifolia L"}amount={50000} btnName={"ReadMore"}  description={"Fresh roots are crushed, boiled and strained, and the liquid is used to treatgonorrhoea and syphilis"} onClick={()=>navigate("/product/info")}/>
        <ProductCard  img1={aboutImage2} img2={aboutImage1} name={"Rubia cordifolia L"}amount={40000} btnName={"ReadMore"}  description={"Fresh roots are crushed, boiled and strained, and the liquid is used to treatgonorrhoea and syphilis"} onClick={()=>navigate("/product/info")}/>
