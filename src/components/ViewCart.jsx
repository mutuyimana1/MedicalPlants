    ...
    <div className="w-full">
      ...
      <div className="w-full lg:w-[70%] px-5 lg:px-0 lg:m-auto md:flex gap-5 ">
        ...
        <div className="w-full md:w-[70%] bg-white   mt-10 p-3">
          ...
          <div className="flex justify-between border border-gray-200 shadow-md">
            <h1 className="p-5">Selcted Product (2 items)</h1>{" "}
            <h1 className="text-lg font-medium p-5">
              Total: <span className="text-orange-500">50 products</span>
            </h1>
          </div>
            ...
            <div className=" sm:flex items-center space-x-4">
              <div className="flex gap-2 pl-3 border w-24 bg-gray-300 mt-5 sm:mt-2 rounded-sm">
                <button
                  ...
                  className=""
                >
                  <TfiMinus size={18} className="" />
                </button>
                <span className="">{countProduct}</span>
                <button onClick={HandleCount}>
                  <LiaPlusSolid className="" size={18} />
                </button>
              </div>
              <div className="bg-orange-100 ml-7 pt-[5px] pl-[5px] mt-10 sm:mt-2 rounded-full hover:bg-red-300  cursor-pointer h-8 w-8">
